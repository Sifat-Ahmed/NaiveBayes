...
class GaussianNaiveBayes:
    ...
    def train(self,train_data):
        ...
        #dropping the label column as its not necessary at this point
        ...
        #print(train_zero_standard_deviation)
        #print(train_one_standard_deviation)

    def test(self, test_data):

        # resetting the index so that it can be accessed with a loop

        test_data.reset_index(inplace=True)

        #Dropping the test label
